...
const items = [
  {
    title: "تبييض الأسنان",
    desc: "استعد إشراقة ابتسامتك بتقنيات تبييض آمنة ونتائج طبيعية.",
    img: "/tabeed.png",
  },
  {
    title: "تجميل الأسنان",
    desc: "تصميم ابتسامة متناسقة (فينير/حشوات تجميلية) بحسب حالتك.",
    img: "/implant.png",
  },
  {
    title: "تقويم الأسنان",
    desc: "حلول تقويم متعددة لتحسين الاصطفاف والإطباق ومظهر الابتسامة.",
    img: "/root-canal.png",
  },
  {
    title: "تنظيف وإزالة الجير",
    desc: "تنظيف احترافي وإزالة الجير للحفاظ على صحة اللثة ومنع الالتهابات.",
    img: "/ortho.png",
  },
  {
    title: "زراعة الأسنان",
    desc: "تعويض ثابت وعملي للأسنان المفقودة باستخدام زرعات عالية الجودة.",
    img: "/cleaning.png",
  },
  {
    title: "علاج العصب",
    desc: "علاج جذور الأسنان لتخفيف الألم وإنقاذ السن بأحدث الأجهزة.",
    img: "/cosmetic.png",
  },
];
    ...
    <section id="services" className="bg-[#f1f3fa]">
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="mt-10 grid gap-10">
          {items.map((it, idx) => {
            const reversed = idx % 2 === 1; // كل خدمة ثانية نعكس مكان الصورة
            const dirForCard = reversed ? "left" : "right";

            return (
              <Reveal
                key={it.title}
                direction={dirForCard as any}
                delayMs={idx === 0 ? 0 : 60}
                durationMs={700}
              >
                <div className="card overflow-hidden">
                  <div className="grid md:grid-cols-2 items-stretch">
                    ...
                    {/* الصورة */}
                    <div
                      className={`relative min-h-[220px] md:min-h-[320px] order-1 ${
