...
const items = [
  { title: "تبييض الأسنان", desc: "استعد إشراقة ابتسامتك بتقنيات تبييض آمنة ونتائج طبيعية.", img: "/tabeed.png" },
  { title: "تجميل الأسنان", desc: "تصميم ابتسامة متناسقة (فينير/حشوات تجميلية) بحسب حالتك.", img: "/implant.png" },
  { title: "تقويم الأسنان", desc: "حلول تقويم متعددة لتحسين الاصطفاف والإطباق ومظهر الابتسامة.", img: "/root-canal.png" },
  { title: "تنظيف وإزالة الجير", desc: "تنظيف احترافي وإزالة الجير للحفاظ على صحة اللثة ومنع الالتهابات.", img: "/ortho.png" },
  { title: "زراعة الأسنان", desc: "تعويض ثابت وعملي للأسنان المفقودة باستخدام زرعات عالية الجودة.", img: "/cleaning.png" },
  { title: "علاج العصب", desc: "علاج جذور الأسنان لتخفيف الألم وإنقاذ السن بأحدث الأجهزة.", img: "/cosmetic.png" },
];
